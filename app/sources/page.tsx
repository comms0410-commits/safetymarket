...
import { monitoredSources } from "@/lib/sample-data";

export const dynamic = "force-static";

export default function SourcesPage() {
  const sources = monitoredSources.slice(0, 40);
  return (
    <AppShell>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="text-3xl font-bold">수집 URL</h1><p className="mt-2 text-slate-500">초기 배포 안정형 버전은 정적 샘플 수집 채널을 표시합니다.</p></div><Button variant="secondary">수집 URL 추가 예정</Button></div>
