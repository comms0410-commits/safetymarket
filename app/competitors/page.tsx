...
export default function CompetitorsPage() {
  return (
    <AppShell>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="text-3xl font-bold">경쟁사 관리</h1><p className="mt-2 text-slate-500">초기 Netlify 버전은 정적 샘플 데이터로 경쟁사 현황을 보여줍니다.</p></div><Button href="/competitors/new">신규 등록 데모</Button></div>
